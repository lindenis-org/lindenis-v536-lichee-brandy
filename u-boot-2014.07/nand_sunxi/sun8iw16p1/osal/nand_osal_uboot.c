...
void ndumpmemhex32(char *name, char *base, int len)
{
	__u32 i;
	...
	for (i = 0; i < len; i += 4) {
		if (!(i & 0xf))
			printf("\n0x%p : ", base + i);
		printf("0x%08lx ", *((ulong *)((ulong)base + i)));
	}
	printf("\n");
}
